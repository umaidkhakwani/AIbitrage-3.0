...
import top_logo from "../../images/3.0/top_logo.png";

import inApp from "../../images/inApp.svg";
import swap_background from "../../images/pools_background.svg";
import app_background from "../../images/3.0/app_background.png";
        ...
        {!isMdScreen ? (
          <Box
            sx={{
              ...
              position: "fixed",
              top: "23px",
              background: "rgba(0, 0, 0, 0.15)", // Transparent background with 0.25 opacity
              borderRadius: "20px",
            }}
          >
            <Grid
                  ...
                  {[
                    ...
                    <Box
                      ...
                      sx={{
                        ...
                        marginBottom: "8px",
                        // backgroundColor: "#2C2C2C", // White background with opacity
                        background: "rgba(0, 0, 0, 0.50)", // Transparent background with 0.25 opacity
                      }}
                    >
                      <Box
                        sx={{
                      ...
                      <Box
                        ...
                        onClick={
                          wallet.name === "Metamask"
                            ? handle_metamask_connect
                            : wallet.name === "Coinbase"
                            ? handle_coinbase_connect
                            : handle_trustWallet_connect
