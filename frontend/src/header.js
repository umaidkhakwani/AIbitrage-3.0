...
function Header_Function() {
  ...
  const TabItem = styled.div`
    ...
    color: ${({ selected }) => (selected ? "#50A883" : "#931D96")};
    cursor: ${({ disabled }) =>
    ...
    &:hover {
      color: ${({ disabled }) =>
        disabled ? null : "#50a883"}; //x Disable hover effect for disabled tabs
    }
  `;
        ...
        >
          ...
          >
            ...
            <Grid
              ...
              sx={{
                display: "flex",
                justifyContent: isMdScreen ? "flex-start" : "flex-start",
                alignItems: "center",
              }}
            >
              {isMdScreen ? (
